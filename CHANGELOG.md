...
- Add billing support to the Toggl
-  Track extension. Added the ability to toggle whether a new task is billable or not, as well as indicators to entries. The billable toggle only shows up if the project selected is billable (as determined by the track API)
